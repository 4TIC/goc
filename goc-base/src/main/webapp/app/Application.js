Ext.Loader.setPath('Ext.ux', 'http://static.uji.es/js/extjs/ext-6.0.3.64/packages/ux/classic/src');
...
Ext.Ajax.request(
{
    url : 'http://static.uji.es/js/extjs/ext-6.0.3.64/build/classic/locale/locale-' + appLang + '.js',
