Ext.define('goc.view.historicoReunion.HistoricoReunionGrid', {
    ...
    columns : [
        ...
        {
            dataIndex : 'urlActa',
            text : getMultiLangLabel(appI18N.reuniones.acta, mainLanguage),
            align : 'center',
            renderer : function(value)
            {
                if (value)
                {
                    return '<a class="link" target="_blank" href="' + value + '"><i class="fa fa-external-link"></i></a>'
                }
                return ''
            }
        }
    ...
    initComponent : function()
    {
        ...
        {
            this.columns.push({
                dataIndex : 'urlActaAlternativa',
                text : getMultiLangLabel(appI18N.reuniones.acta, alternativeLanguage),
                align : 'center',
                renderer : function(value)
                {
                    if (value)
